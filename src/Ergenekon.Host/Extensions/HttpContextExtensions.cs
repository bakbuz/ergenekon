...
public static class HttpContextExtensions
{
    ...
    {
        if (httpContext == null || httpContext.Request.ContentLength == null) return string.Empty;
    ...
    {
        if (httpContext == null || httpContext.Response.Body.CanRead == false) return string.Empty;
